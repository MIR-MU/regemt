...
def cli_main():
    ...
    parser.add_argument('--prism_a', type=float, help='prism_a ** prism_b. reasonable starting point: 0.003',
                        required=True)
    parser.add_argument('--prism_b', type=float, help='prism_a ** prism_b. reasonable starting point: 4.0',
                        required=True)
